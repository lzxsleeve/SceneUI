 ...
 */
public class BarHeightView extends View {
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.BarHeightView);
            type = typedArray.getInt(R.styleable.BarHeightView_use_type, 0);
            typedArray.recycle();
        }
        if (type == 1) {
